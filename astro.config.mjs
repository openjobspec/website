      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Distributed Tracing', slug: 'spec/distributed-tracing' },
            ...
            { label: 'Federation', slug: 'spec/federation' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'How We Test 5 Backends', slug: 'blog/how-we-test-5-backends' },
            { label: 'Migrating from Sidekiq', slug: 'blog/migrating-from-sidekiq' },
          ],
        },
        {
          label: 'Governance',
