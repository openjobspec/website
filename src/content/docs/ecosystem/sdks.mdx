...
## Experimental: WASM SDK

**Repository:** `ojs-wasm-sdk/`
**Status:** Planning phase

A browser-native WebAssembly SDK is in development, targeting edge and serverless use cases:

- **CloudFlare Workers** and **Vercel Edge Functions**
- **Deno Deploy**
- **Browser clients** (powering the [OJS Playground](https://play.openjobspec.org))

The planned architecture compiles a Rust core to `wasm32-unknown-unknown`, with JavaScript bindings and TypeScript type definitions. Follow the [roadmap](/governance/roadmap/) for progress updates.
